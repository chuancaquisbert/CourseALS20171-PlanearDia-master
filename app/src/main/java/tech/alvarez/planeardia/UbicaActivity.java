...
public abstract class UbicaActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
            ...
            public void onResult(@NonNull LocationSettingsResult result) {
                ...
                if (status.getStatusCode() == LocationSettingsStatusCodes.SUCCESS) {
                    ...
                    try {
                        ...
                        status.startResolutionForResult(UbicaActivity.this, 999);
                    ...
                    Toast.makeText(UbicaActivity.this, "No podemos abrir de nuevo el diálogo de configuraciones, activalo manualmente", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
