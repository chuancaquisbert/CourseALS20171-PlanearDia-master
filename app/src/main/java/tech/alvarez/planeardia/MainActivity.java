...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private double lat=-16.497953;
    private double lon=-68.123115;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googleApiClient = new GoogleApiClient.Builder(this)
                ...
                .build();
        Database.eliminarRegistros(this);
        //Database.guardarUbicacion(this, "nombre", "direccion",-16.497953 ,-68.123115 , "telefono", "website");
        //Database.guardarUbicacion(this, "nombre", "direccion",-16.500215 ,-68.132079 , "telefono", "website");
        //Database.guardarUbicacion(this, "nombre", "direccion",-16.502789 ,-68.128787 , "telefono", "website");
    ...
    public void onLocationChanged(Location location) {
        ...
        double latitud = location.getLatitude();//place.getLatLng().latitude;
        double longitud = location.getLongitude();//place.getLatLng().longitude;
    ...
    private void iniciarObtenerUbicaciones() {
        if (tenemosPermisoUbicacion()) {
            ...
            //es un error que no detiene la ejecucion
            //verifica si estamos pidiendo permiso, que esta en el metodo del if
        } else {
    ...
    private void detenerObtencionUbicaciones() {
        Toast.makeText(this, "Detenter Obtener de Ubicaciones", Toast.LENGTH_LONG).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 888) {
            if (resultCode == RESULT_OK) {
                ...
                // TODO: PASO 2 para acceder al lugar
                ...
                String telefono = place.getPhoneNumber() != null ? place.getPhoneNumber().toString() : "No tiene telÃ©fono";
    ...
    public void detener(View view) {
        // Cuando se presionar el botÃ³n detener
        if(googleApiClient.isConnected())
        {
            detenerObtencionUbicaciones();
        }
    ...
    public void verEnMapa(View view) {
        // Cuando se presionar el botÃ³n de ver mapa

        Intent intent = new Intent(this, MapsActivity.class);
        startActivity(intent);
    }
    //l
    public void listaPuntos(View view) {
        // Cuando se presionar el botÃ³n de ver mapa
