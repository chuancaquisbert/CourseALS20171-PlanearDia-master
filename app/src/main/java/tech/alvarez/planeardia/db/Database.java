...
public class Database {
    ...
    public static void guardarUbicacion(Context context, String nombre, String direccion, double latitud, double longitud, String telefono, String website) {
    ...
    public static void eliminarRegistros(Context context) {
        DatabaseHelper dbHelper = new DatabaseHelper(context);
